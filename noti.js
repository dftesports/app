const localUsername = localStorage.getItem('dft_local');

async function fetchUserData(username) {
    try {
        const response = await fetch('https://script.google.com/macros/s/AKfycbzRsFrq_hrWuOFfsLRdduTsWrj_NdpzBJ_NrZhbAjiSl_F9Q3whAw7K-UjaiksDt_QB/exec?username=' + username);
