...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbzBTTElAGqAxaVfAEUQM3VZ-iKZLUEgF4B2meY-mrXIHhtn3rKrKlqhEjhYgpj9GFLM/exec';
...
async function uploadToImgur(file) {
    ...
    const response = await fetch('https://api.imgur.com/3/image', {
        method: 'POST',
        headers: {
            'Authorization': 'Client-ID 3998de887d78ec8'
        },
        body: formData
    });
